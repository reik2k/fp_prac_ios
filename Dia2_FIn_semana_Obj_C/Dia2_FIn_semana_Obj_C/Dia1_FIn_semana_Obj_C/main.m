...
int main(int argc, const char * argv[]) {
    ...
    cadena = [cadena initWithFormat:@"Valor del punto medio %f, %f", CGRectGetMidX(miFrame), CGRectGetMidY(miFrame)];
        ...
        OtraPersona *persona1 = [[OtraPersona alloc] init];
        //%f float, CGFloat....
        //%lf double
        //%d int
        //%ld NSinteger, long
        ...
        NSLog(@"Resultado");
        persona1 = nil;
        persona1 = [[OtraPersona alloc] initWithNombre:@"Juan"];
        ...
        NSString *fechaACadena = [formatter cadenaFormatoGuionDeFecha:fechaNac];
        NSString *horaACadena = [formatter horaAPartirDeFecha:fechaNac];
        ...
        //Gritamos el nombre de la persona
		NSLog(@"%@",[personaConConstructor nombreEnMayusculas] );
    }
    return 0;
}
