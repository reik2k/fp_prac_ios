...
+(instancetype)newPersonaConNombre:(NSString *)personaNombre yApellidos:(NSString *)personaApellidos viviendoEn:(Vivienda *)casa{
    OtraPersona *persona = [OtraPersona new]; //igual que [[Persona alloc] init];
	...
	//PRovoca warning por ser de tipo OtraPersona y esperar Persona2, pero sigue adelante!
